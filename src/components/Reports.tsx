    ...
    <div className="p-6 max-w-md mx-auto min-h-screen pb-24">
      <header className="flex items-center justify-between mb-8">
        ...
        <input 
          ...
          className="px-3 py-2 rounded-xl bg-white border border-wood-medium text-coffee-dark text-sm font-medium focus:outline-none focus:border-coffee-brown focus:ring-2 focus:ring-coffee-brown/20"
        />
      </header>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-white p-5 rounded-[24px] shadow-[0_2px_8px_rgba(200,169,139,0.1)] border border-wood-light flex flex-col items-center text-center">
          <div className="p-2.5 bg-wood-light rounded-xl mb-3">
            <ArrowUpCircle size={28} className="text-coffee-dark" />
          </div>
          ...
          {filteredMovements.length === 0 ? (
            ...
            filteredMovements.map((movement) => (
              <div key={movement.id} className="bg-white p-4 rounded-2xl shadow-[0_2px_8px_rgba(200,169,139,0.05)] border border-wood-light flex items-center justify-between transition-transform active:scale-[0.98]">
                <div className="flex items-center gap-3">
                  <div className={`p-2 rounded-xl ${movement.type === 'in' ? 'bg-wood-light text-coffee-dark' : 'bg-accent-red-bg text-accent-red'}`}>
                ...
                <div className="text-right">
                  <p className={`font-bold text-lg leading-tight ${movement.type === 'in' ? 'text-coffee-dark' : 'text-accent-red'}`}>
